	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
		 <li class="breadcrumb-item"><a href="../Product Overview/Sports Product Page.php">Sports Watches</a></li>
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        ...
                        <div class="carousel-item carousel-product active">
                            <img class="d-block mx-auto" src="../../images/Sport Watches/1/Sports 1 DW-5900-1ER.jpg" alt="Casio DW 5900-1ER Face" title="Casio DW 5900-1ER Face">
                        </div>
                        <div class="carousel-item carousel-product">
                            <img class="d-block mx-auto" src="../../images/Sport Watches/1/Sports 1 DW-5900-1ER (2).jpg" alt="Casio DW 5900-1ER Strap" title="Casio DW 5900-1ER Strap">
                        </div>
                    </div>
