...
<head>
  <meta name="Description" content="Watch.Me Sports Casio GBD-800UC-3">
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="shortcut icon" type="image/x-icon" href="../../images/Favicon/favicon.png">
  <title>Sports Casio GBD-800UC-3</title>
...
<div class="container-fluid-remove-paddings">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Casio GBD-800UC-3</li>
	  </ol>
	</nav>
</div>
<!--End of Breadcrumb -->
    ...
    <div class="row">
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        ...
                        <div class="carousel-item carousel-product active">
                            <img class="d-block mx-auto" src="../../images/Sport Watches/4/Sports 4 Casio GBD-800UC-3 (Grey) 1.jpg" alt="Casio GBD-800UC-3 Face" title="Casio GBD-800UC-3 Grey">
                        </div>
                        <div class="carousel-item carousel-product">
                            <img class="d-block mx-auto" src="../../images/Sport Watches/4/Sports 4 Casio GBD-800UC-3 (Olive Green) 2.jpg" alt="Casio GBD-800UC-3 Face" title="Casio GBD-800UC-3 Olive">
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6 detcol">
            ...
            <div class="detailblock">
                <br>
                <h5>Mens Casio GBD-800UC-3</h5>
                <h6>Casio</h6><br>
                <h5>S$103.00</h5><br><hr>
                <h6>10 in stock</h6><br><br>
        ...
        <div class="card">
            ...
            <div id="details" class="panel-collapse collapse insideInfo">
                <div class="row">
                    ...
                    <div class="col-6">
                        <p>
                            <p>These are the latest additions to the new G-SQUAD sports lineup from G-SHOCK.
							The good-looking designs and utility colors of these models maximize coordination possibilities with both everyday fashions and training wear.</p>

							<p>Function-wise, these watches link with the G-SHOCK Connected phone app to provide access to a number of functions that enhance workouts. Daily health and fitness support functions include a 3-axis accelerometer that keeps track of step counts, a Multi-Timer that lets you create up to 20 timer combinations of five timers each, memory for up to 200 lap records, and more. The app also makes it possible to maintain step count logs with five exercise intensity levels, to calculate the calories you burn, to specify a daily step target, to create timer combinations and send them to the watch, to store stopwatch measurement data, to view data, and more. All of this combines to help you plan and record your workouts, making them more effective and enjoyable.
							Other features include app-based auto time setting correction and other features for more efficient timekeeping, and an Auto LED Light to facilitate workouts in areas where lighting is dim.</p>

							<p>Back wings on the inside of the bands where they connect to the case, a new band ring shape that prevents sliding, and more band holes to allow better tightness adjustment, all add up to a more comfortable fit. You can make fine adjustments to the band size.</p>

							<p>Step count using a 3-axis accelerometer (Step Count Graph, step goal progress graphic)
							Stopwatch with Target Time alarm (lap/split display switching, up to 10 Target Times, 200 lap time records)</p>

							<p>Interval timer with up to five time settings (Auto repeat up to 20 times, skip, auto start, alert sound)</p>
                    ...
                    <div class="col-6">
                        <ul>
                            ...
                            <li>
                                <strong>Model Name:</strong> 800UC-3
                            </li>
                            <li>
                                <strong>Movement Source:</strong> Japanese
                            </li>
                            <li>
                                <strong>Guarantee:</strong> 3 years
                            </li>
                            <li>
        ...
        <div class="card">
            <div class="card-header">
                <a data-toggle="collapse" href="#materials">
                    <h5>Materials and Extra Info</h5>
                </a>
            </div>
