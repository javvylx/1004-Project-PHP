...
<head>
  <meta name="Description" content="Watch.Me Casual Pulsar PS9527X1">
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="shortcut icon" type="image/x-icon" href="../../images/Favicon/favicon.png">
  <title>Casual Pulsar PS9527X1</title>
...
<div class="container-fluid-remove-paddings">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Casual Pulsar PS9527X1</li>
	  </ol>
	</nav>
</div>
<!--End of Breadcrumb -->
    ...
    <div class="row">
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        ...
                        <div class="carousel-item carousel-product active">
                            <img class="d-block mx-auto" src="../../images/Casual Watches/3/Casual 3 Pulsar PS9527X1.jpg" alt="Pulsar PS9527X1 Face" title="Pulsar PS9527X1 Face">
                        </div>
                        <div class="carousel-item carousel-product">
                            <img class="d-block mx-auto" src="../../images/Casual Watches/3/Casual 3 Pulsar PS9527X1 (2).jpg" alt="Pulsar PS9527X1 Wrist" title="Pulsar PS9527X1 Wrist">
                        </div>
                    </div>
        ...
        <div class="col-lg-6 detcol">
            ...
            <div class="detailblock">
                <br>
                <h5>Pulsar Dress Watch PS9527X1</h5>
                <h6>Pulsar</h6><br>
                <h5>S$150.56</h5><br><hr>
                <h6>18 in stock</h6><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul>
                            ...
                            <li>
                                <strong>Model Name:</strong> Dress
                            </li>
                            <li>
