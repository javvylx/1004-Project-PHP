...
<head>
  <meta name="Description" content="Watch.Me Sports Casio SGW-100-1VEF3">
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="shortcut icon" type="image/x-icon" href="../../images/Favicon/favicon.png">
  <title>Sports Casio SGW-100-1VEF3</title>
...
<div class="container-fluid-remove-paddings">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Sports Casio SGW-100-1VEF3</li>
	  </ol>
	</nav>
</div>		
<!--End of Breadcrumb -->
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        ...
                        <div class="carousel-item carousel-product active"> 
                            <img class="d-block mx-auto" src="../../images/Sport Watches/2/Sports 2 Casio SGW-100-1VEF.jpg" alt="Casio SGW-100-1VEF Face" title="Casio SGW-100-1VEF Face">
                        </div>
                        <div class="carousel-item carousel-product"> 
                            <img class="d-block mx-auto" src="../../images/Sport Watches/2/Sports 2 Casio SGW-100-1VEF3 (2).jpg" alt="Casio SGW-100-1VEF Strap" title="Casio SGW-100-1VEF Strap">
                        </div>
                    </div>
...
<!--End of Carousel-->
        ...
        <div class="col-lg-6 detcol">
            ...
            <div class="detailblock">
                <br>
                <h5>Mens Casio Pro Trek Alarm Chronograph Watch SGW-100-1VEF</h5>
                <h6>Casio</h6><br>
                <h5>S$90.67</h5><br><hr>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul>
                            ...
                            <li>
                                <strong>Model Name:</strong> Pro Trek
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>MPN:</strong> SGW-100-1VEF
                            </li>
                        </ul>
                    </div>
                </div>
