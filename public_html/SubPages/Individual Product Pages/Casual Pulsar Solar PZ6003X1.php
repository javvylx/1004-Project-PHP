...
<head>
  <meta name="Description" content="Watch.Me Casual Pulsar Solar PZ6003X1">
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="shortcut icon" type="image/x-icon" href="../../images/Favicon/favicon.png">
  <title>Casual Pulsar Solar PZ6003X1</title>
...
<div class="container-fluid-remove-paddings">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Casual Pulsar Solar PZ6003X1</li>
	  </ol>
	</nav>
</div>
<!--End of Breadcrumb -->
    ...
    <div class="row">
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        <div class="carousel-item carousel-product active">
                            <img class="d-block mx-auto" src="../../images/Casual Watches/1/Pulsar Original Size.jpg" alt="Pulsar Solar PZ6003X1 Face" title="Pulsar Solar PZ6003X1 Face">
                            <div class="carousel-caption">
                            </div>
                        </div>
                        <div class="carousel-item carousel-product">
                            <img class="d-block mx-auto" src="../../images/Casual Watches/1/Casual 1 Pulsar Solar PZ6003X1 (2).jpg" alt="Pulsar Solar PZ6003X1 Strap" title="Pulsar Solar PZ6003X1 Strap">
                            <div class="carousel-caption">
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6 detcol">
            ...
            <div class="detailblock">
                <br>
                <h5>Pulsar Stainless Steel Solar Chronograph Watch PZ6003X1</h5>
                <h6>Pulsar</h6><br>
                <h5>S$145.39</h5><br><hr>
                <h6>30 in stock</h6><br><br>
        ...
        <div class="card">
            ...
            <div id="details" class="panel-collapse collapse insideInfo">
                <div class="row">
                    ...
                    -->
                    <div class="col-6">
                            <p>Pulsar PZ6003X1 is a super very impressive Gents watch. Case is made out of Stainless Steel, which stands for a high quality of the item and the Black dial gives the watch that unique look. The features of the watch include (among others) a chronograph and date function.</p>

							<p>100 metres water resistancy will protect the watch and allows it to get submerged in the water for everyday usage including swimming, but not high impact water sports. </p>
                    </div>
                    <div class="col-6">
                        <ul>
                            <li>
                                <strong>Brand:</strong> Pulsar
                            </li>
                            <li>
                                <strong>Model Collection:</strong> Pulsar Solar Casual
                            </li>
                            <li>
                                <strong>Model Name:</strong> Pulsar PZ6003X1
                            </li>
                            <li>
                                <strong>Guarantee:</strong> 3 years
                            </li>
                            <li>
                                <strong>Packaging:</strong> Pulsar Packaging
                            </li>
                            <li>
                                <strong>MPN:</strong> Pulsar PZ6003X1
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div id="materials" class="panel-collapse collapse insideInfo">
                <ul>
                    ...
                    <li>
                        <strong>Dial Color:</strong> Silver
                    </li>
                    <li>
                        <strong>Glass:</strong> Mineral
                    </li>
                    <li>
                        <strong>Strap Color:</strong> Silver
                    </li>
                    <li>
                        <strong>Strap Type:</strong> Metal bracelet
                    </li>
                    <li>
                        <strong>Water Resistance:</strong> 100 metres
                    </li>
                </ul>
            </div>
        </div>
