...
if (isset($_POST['login-submit'])) {
    ...
    if (check_empty($email) || check_empty($password)) {
        header("Location: login_page.php?error=emptyfields&email=".$email);
        exit();
    } else {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($pwdCheck == false) {
                    header("Location: login_page.php?error=wrongpwd&password");
                    exit();
                ...
                header("Location: login_page.php?error=wrongcred");
                exit();
            }
        }
    }
