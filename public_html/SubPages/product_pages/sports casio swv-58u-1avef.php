                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        ...
                        <div class="carousel-item carousel-product active">
                            <img class="d-block mx-auto" src="../../images/sports_watches/2/sports_2_casio_sgw-100-1vef.jpg" alt="Casio SWV-58U-1AVEF Face" title="Casio SWV-58U-1AVEF Face">
                        </div>
                        <div class="carousel-item carousel-product">
                            <img class="d-block mx-auto" src="../../images/sports_watches/2/sports_2_casio_sgw-100-1vef(2).jpg" alt="Sports Casio SWV-58U-1AVEF Strap" title="Casio SWV-58U-1AVEF Strap">
                        </div>
                    </div>
