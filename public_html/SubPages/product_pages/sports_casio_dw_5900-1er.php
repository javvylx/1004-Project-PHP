...
<head>
  ...
  <title>Sports Casio DW 5900-1ER</title>
	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
		 <li class="breadcrumb-item"><a href="../product_overview/sports_product_page.php">Sports Watches</a></li>
		<li class="breadcrumb-item active" aria-current="page">Sports Casio DW 5900-1ER</li>
	  </ol>
	</nav>
</div>
<!--End of Breadcrumb -->
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: gray; border-radius:25px">
                    ...
                    <div class="carousel-inner ImgBox" role="listbox">
                        ...
                        <div class="carousel-item carousel-product active">
                            <img class="d-block mx-auto" src="../../images/sports_watches/1/sports_1_dw-5900-1er.jpg" alt="Casio DW 5900-1ER Face" title="Casio DW 5900-1ER Face">
                        </div>
                        <div class="carousel-item carousel-product">
                            <img class="d-block mx-auto" src="../../images/sports_watches/1/sports_1_dw-5900-1er(2).jpg" alt="Casio DW 5900-1ER Strap" title="Casio DW 5900-1ER Strap">
                        </div>
                    </div>
